...
2. courserouter. post with purchase with usermiddleware fucti req, res
3. var userid = req userid
4. var courseid = req.body.courseid
5. if not courseid return res status msg provide courseid

6. var existingpurchase with purchasemodel. findone with courseid and userid
7. if existingpurchase return status with msg already bought
8. create purchase model with courseid and userid
9. res status with msg successfully bought

10. courserouter get path with preview function req, res
11. var course from coursemodel find
12. jus res.status with courses
13. export module with courserouter
*/