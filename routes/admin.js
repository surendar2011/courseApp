...
/*
1. import router, adminrouter, adminmodel, adminmiddleware,jwt, bcrypt, z, jwt admin password
3. adminrouter.post signup with fucn req, req
4. var requiredBody email, password, firstname, lastname
5. parsedDataSuccess with requiredboay safeparse with req.body
6. if not parseddatasuccess return with msg incorrect format
7. put email everythin in req.body
8. var hashedpassword with bcrypt
9. try
10. adminmodel to create email everythin
11. catch with res status and msg: already singup
12. jus res msg signup successful

13. adminrouter put for course with usermiddleware
14. var adminid req userid
15. const requiredbody with course details
16. var parsedatawithsuccess
17.if not parsedata return res msg and error incorrct format
18. put title.... into req.body
19. var course to match the coursemodel findone
20. if not course status and msg: course not found


21. course model update one withc courseid and admin
22. match with all details like title description
23. jus res status and msg: course updated

24. adminrouter get course buld
25. var adminid and courses
26. jus res with msg and course, course updated
27. export modules
*/